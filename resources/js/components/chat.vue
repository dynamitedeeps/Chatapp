<template>
	<div class="chat-card">
		<div class="scrollable card-body" ref="hasScrolledToBottom">
			<template v-form="message in messages">
		...
		<div class="chat-form input-group">
			<input id="btn-input" type="text" name="message" class="form-control input-sm message-" placeholder="Type your message here..." v-model="newMessage" @key-enter="addMessage">
			<span class="input-group-btn">
				<button class="btn btn-primary" id="btn-chat" @click="addMessage"></button>
			</span>
		</div>
	</div>
</template>
